...
const Research: React.FC = () => {
    return (
        <MainLayout>
            <div className="mb-8 text-center  inset-0 bg-gradient-to-t from-transparent to-main/5 px-10 py-14 rounded-xl">
                <h1 className="text-3xl font-semibold flex gap-3 justify-center "><Search className="my-auto text-main/80" size={36} /> Research Focus</h1>
