    ...
    return (
        <MainLayout>
            <div className="mb-12 mt-2 text-center ">
                <h1 className="text-3xl font-semibold flex gap-3 justify-center bg-gradient-to-t from-transparent to-main/5 p-8 rounded-xl w-fit mx-auto "><Microscope className="my-auto text-main/80" size={36} /> Research Focus</h1>
